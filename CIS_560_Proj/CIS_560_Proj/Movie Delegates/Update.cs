...
{
    internal class DeleateDelegate : NonQueryDataDelegate<Movie>
    {
        ...
        public DeleateDelegate(int Movie,string ProductionId, string MovieName, string ReleaseDate)
           : base("Film.DeleateMovie")
        {
        ...
        {
            return new Movie((int)command.Parameters["MovieId"].Value, Convert.ToInt32(ProductionId), MovieName, ReleaseDate, "Deleated");
        }
    }
