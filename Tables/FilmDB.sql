...
(
		...
		CreatedOn Nvarchar(64),
		UpdatedOn DATETIMEOFFSET NOT NULL DEFAULT(SYSDATETIMEOFFSET()),
		IsDeleted NvarChar(64) DEFAULT ('NULL'),
	...
	(
		...
		ReleaseDate Nvarchar(64) not null,
		IsDeleted NvarChar(64) DEFAULT ('NULL'),
	...
	(
        ...
        DeathDate Nvarchar(32) Default ('NULL'),
		IsDeleted NvarChar(64) DEFAULT ('NULL'),
		CreatedOn DATETIMEOFFSET NOT NULL DEFAULT(SYSDATETIMEOFFSET()),
		UpdatedOn DATETIMEOFFSET NOT NULL DEFAULT(SYSDATETIMEOFFSET()),
		PRIMARY KEY CLUSTERED
...
CREATE	TABLE Film.IndividualAwardsWon
	(
		...
		CreatedOn DATETIMEOFFSET NOT NULL DEFAULT(SYSDATETIMEOFFSET()),
		UpdatedOn DATETIMEOFFSET NOT NULL DEFAULT(SYSDATETIMEOFFSET()),
		PRIMARY KEY(IndividualAwardsWonId),

       FOREIGN KEY(MoviePersonId) REFERENCES Film.MoviePerson(MoviePersonId)
	...
	(
      ...
      FOREIGN KEY(IndividualAwardsWonId)
      REFERENCES Film.IndividualAwardsWon(IndividualAwardsWonId),
	  FOREIGN KEY(MovieAwardsWonId)
      REFERENCES Film.MovieAwardsWon(MovieAwardsWonId)
	);
